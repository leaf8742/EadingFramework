#import "BodyAttachment.h"

#if !__has_feature(objc_arc)
#error BodyAttachment must be built with ARC.
// You can turn on ARC for only BodyAttachment.m by adding -fobjc-arc to the build phase.
#endif

@implementation BodyAttachment
