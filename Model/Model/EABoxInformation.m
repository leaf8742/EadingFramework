...
#error EABoxInformation must be built with ARC.
// You can turn on ARC for only EABoxInformation.m by adding -fobjc-arc to the build phase.
#endif

@implementation EABoxInformation
...
- (id)initWithIdentity:(NSString *)identity {
    if (self = [self init]) {
        ...
        self.objectType = kEAObjectTypeBox;
    }
    return self;
}
