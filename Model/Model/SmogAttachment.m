#import "SmogAttachment.h"

#if !__has_feature(objc_arc)
#error SmogAttachment must be built with ARC.
// You can turn on ARC for only SmogAttachment.m by adding -fobjc-arc to the build phase.
#endif

@implementation SmogAttachment
