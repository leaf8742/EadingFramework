...
#error CameraInformation must be built with ARC.
// You can turn on ARC for only CameraInformation.m by adding -fobjc-arc to the build phase.
#endif
...
#warning attachment 是attachmentList selectedAttachment的映射
...
- (id)initWithIdentity:(NSString *)identity {
    if (self = [self init]) {
        ...
        self.objectType = kEAObjectTypeCamera;
    }
    return self;
}
