#import "TemperatureHumidityAttachment.h"

#if !__has_feature(objc_arc)
#error TemperatureHumidityAttachment must be built with ARC.
// You can turn on ARC for only TemperatureHumidityAttachment.m by adding -fobjc-arc to the build phase.
#endif

@implementation TemperatureHumidityAttachment
...
- (id)initWithIdentity:(NSString *)identity {
    if (self = [self init]) {
        ...
        self.type = kAttachmentTypeTemperatureHumidity;
    }
    return self;
}
